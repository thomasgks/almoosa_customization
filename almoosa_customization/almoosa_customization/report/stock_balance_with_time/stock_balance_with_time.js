...
frappe.query_reports["Stock Balance with Time"] = {
	filters: [
		{
			fieldname: "company",
			label: __("Company"),
		...
		},
		{
			...
			width: "80",
			reqd: 1,
			// Constructs "YYYY-01-01 00:00:00" using native JS
			default: new Date().getFullYear() + "-01-01 00:00:00",
		},
		{
			fieldname: "to_date",
			label: __("To Date"),
			...
			width: "80",
			reqd: 1,
			// Standard Frappe JS function for current timestamp
